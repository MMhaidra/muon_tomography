...
class Track:
    ...
    def update(self, intersections=None):
        ...
        if self.intersections is not None and len(self.intersections) > 0 and self.intersections[0][2] < 1e-6:
            self.ray.p = self.ray.p + self.ray.d + (self.intersections[0][2]+1e-9)
